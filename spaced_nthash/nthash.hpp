...
// CHANGED BY JONAS FISCHER
// static table for reduced alphabet representation of genomic sequences
// i.e. replaced occurences of seeds for C by seeds for T
static const uint64_t *msTab[256] = {
    vecN, vecT, vecN, vecG, vecA, vecN, vecN, vecT, // 0..7
    ...
    vecN, vecA, vecN, vecT, vecN, vecN, vecN, vecG, // 64..71
    ...
    vecN, vecA, vecN, vecT, vecN, vecN, vecN, vecG, // 96..103
